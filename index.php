...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="img-fluid" src="images/slider/slide1.png  " alt="" width="100%" height="500">
      <div class="carousel-caption text-dark">
        <h3 >Easy Notes Management</h3>
        <p>Now easily manage all kind of notes by uploading them here.</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img class="img-fluid" src="images/slider/slide2.png" alt="" width="100%" height="500">
      <div class="carousel-caption text-dark">
    ...
    <div class="carousel-item">
      <img class="img-fluid" src="images/slider/slide3.png" alt="" width="100%" height="500">
      <div class="carousel-caption text-dark">
        <h3>Controled By Admin</h3>
        <p>Everying is managed and controled by administrator</p>
      </div>   
    </div>
	<div class="carousel-item">
      <img class="img-fluid" src="images/slider/slide4.png" alt="" width="100%" height="500">
      <div class="carousel-caption text-dark">
        <h3>Login For Both Teacher and Student</h3>
